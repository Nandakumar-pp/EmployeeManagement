    ...
    try {
       ...
       // const employee = await Employee.findOne({ employeeId });
        const newLeave=new Leave({
           employeeId: employee._id,leaveType,startDate,endDate,reason,days:new Date(endDate).getDate() -
...
export {addLeave,getLeave,getLeaves,getLeaveDetail,updateLeave,getEmpLeave}